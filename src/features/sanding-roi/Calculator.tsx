    ...
    <div ref={topRef} className="scroll-mt-24 min-h-[600px]">
      ...
      {step === 0 && (
        <StepShell
          ...
          title={
            <>
              What can an <em className="not-italic text-[var(--color-tan-500)]">automated sanding machine</em> save you?
            </>
          }
          description="Consistent, high-quality surface finishing — calculate your time savings and payback period in under 2 minutes."
        >
          <div className="grid gap-4 sm:grid-cols-2">
            <IntroCard
              phase="Phase 1"
              title="Production Data"
              desc="Select the panels you currently sand manually, then enter your weekly volumes and the total operator hours spent on sanding today."
            />
            <IntroCard
              phase="Phase 2"
              title="Your Results"
      ...
      {step === 1 && (
        <StepShell
          ...
          description="Tick all the panel types you currently sand manually. If unsure, start with all selected and remove any that don't apply."
        >
      ...
      {step === 2 && (
        <StepShell
          ...
          description="Enter how many of each panel you sand per week. Then enter the total hours your operators spend on manual sanding — add them all up across all operators."
        >
          ...
          <FieldRow
            label="Current sanding hours per week (all operators)"
            hint="Add up all sanding hours across all operators. Example: 2 operators × 4 hrs/day × 5 days = 40 hrs/week."
            unit="hrs / week"
            tooltip="This is the total time your team currently spends on manual sanding each week — across all operators combined. Example: if 2 people each sand 4 hrs/day × 5 days, that is 40 hrs/week."
          >
            <NumberInput
